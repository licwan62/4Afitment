...
```text
D:\Home\Scripts\4Afitment\scrapers\4afitment\projects
```
...
```powershell
.\run.ps1 src/scrape-from-tsv.js --projects-dir D:\Home\Scripts\4Afitment\scrapers\4afitment\projects --project brandlimit_0617
```
